...
function HomePage({ onLoginClick }) {
  ...
  // Rotate first set of headings every 3 seconds
  useEffect(() => {
    const interval = setInterval(() => {
      setActiveHeadingIndex((prev) => (prev + 1) % 6);
    }, 3000);
    return () => clearInterval(interval);
  }, []);

  // Rotate second set of headings every 3 seconds
  useEffect(() => {
    const interval = setInterval(() => {
      setActiveHeadingIndex2((prev) => (prev + 1) % 6);
    }, 3000);
    return () => clearInterval(interval);
  }, []);
          ...
          <div className="row">
            ...
            <div className="statistics__wrapper">
              <div className="statistics__content--header">
                ...
                <div className={`statistics__heading ${activeHeadingIndex === 3 ? 'statistics__heading--active' : ''}`}>
                  Develop better parenting skills
                </div>
                <div className={`statistics__heading ${activeHeadingIndex === 4 ? 'statistics__heading--active' : ''}`}>Increase happiness</div>
                <div className={`statistics__heading ${activeHeadingIndex === 5 ? 'statistics__heading--active' : ''}`}>
            ...
            <div className="statistics__wrapper">
              ...
              >
                <div className={`statistics__heading ${activeHeadingIndex2 === 0 ? 'statistics__heading--active' : ''}`}>Expand your learning</div>
                <div className={`statistics__heading ${activeHeadingIndex2 === 1 ? 'statistics__heading--active' : ''}`}>Accomplish your goals</div>
                <div className={`statistics__heading ${activeHeadingIndex2 === 2 ? 'statistics__heading--active' : ''}`}>Strengthen your vitality</div>
                <div className={`statistics__heading ${activeHeadingIndex2 === 3 ? 'statistics__heading--active' : ''}`}>Become a better caregiver</div>
                <div className={`statistics__heading ${activeHeadingIndex2 === 4 ? 'statistics__heading--active' : ''}`}>Improve your mood</div>
                <div className={`statistics__heading ${activeHeadingIndex2 === 5 ? 'statistics__heading--active' : ''}`}>Maximize your abilities</div>
              </div>
            </div>
          </div>
        </div>
